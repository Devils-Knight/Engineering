...
extern far_proc 		
; 			[ FAR PROCRDURE USING EXTERN DIRECTIVE ]
global filehandle, char, buf, abuf_len
%include "assignment10_macro.asm"


section .data
	nline db 10
	nline_len equ $-nline
	ano db 10,10,"Write X86 ALP to find,",10," a) Number of Blank spaces",10," b) Number of lines",10," c) Occurrence of a particular character."
	db 10,"-------------------------------------------------------",10
	ano_len equ $-ano
...
section .text
	global _start
_start:
	display ano,ano_len 			;assignment.
