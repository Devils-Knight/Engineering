...
section .data
	menu db 'Choose a Command from the Menu : ',0Ah
	db "1. TYPE (use --> type filename.txt)",0Ah
	db "2. COPY (use --> copy file1.txt file2.txt)",0Ah
	db "3. DELETE (use --> del filename.txt)",0Ah
	db "4. Exit",0Ah
